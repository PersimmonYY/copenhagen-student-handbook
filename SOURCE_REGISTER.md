...
|---|---|---|---|---|---|
| SIRI-STUDY-FEE | 学习类案件处理费 3,060 DKK（2026） | `visa_permit.tex` | <https://www.nyidanmark.dk/en-GB/You-want-to-apply/Study/Higher-education> | 2026-09-02 | 2027-01 或发布前 |
| SIRI-SELF-SUPPORT | 7,426 DKK/月、最多 89,112 DKK（2026） | `visa_permit.tex` | 同上 | 2026-09-02 | 2027-01 或发布前 |
| SIRI-STUDENT-WORK | 9--5 月每月 90 小时、6--8 月可全职 | `job_internship.tex` | <https://www.nyidanmark.dk/en-GB/Words-and-concepts/SIRI/Work-permits-for-students-in-higher-educational-programmes> | 2026-09-02 | 每次发布 |
| SIRI-BENEFITS | 学生许可的 SU、住房补贴等公共福利限制 | `visa_permit.tex` | <https://www.nyidanmark.dk/en-GB/You-want-to-apply/Study/Higher-education> | 2026-09-02 | 每次发布 |
| SIRI-INTERNSHIP | 全职课程实习及 ST4 判断 | `job_internship.tex` | <https://nyidanmark.dk/en-GB/You-want-to-apply/Study/Study-internship> | 2026-09-02 | 每次发布 |
| SIRI-JOBSEEK-WORK | 毕业求职期无工时限制工作许可 | `job_internship.tex` | <https://www.nyidanmark.dk/en-GB/You-want-to-apply/Study/Work-permit--job-seeking> | 2026-09-02 | 每次发布 |
| IHC-CPR | 非欧盟 CPR 登记条件和办理入口 | `arrival_30_days.tex` | <https://ihcph.kk.dk/registration-guidance> | 2026-09-02 | 入学季前 |
| CPH-YELLOW-CARD | 黄卡通常 2--4 周、4 周查询 | `arrival_30_days.tex`, `life_guide.tex` | <https://international.kk.dk/live/healthcare/health-insurance/yellow-health-card> | 2026-09-02 | 每次发布 |
...
1. 对所有 Claim ID 打开官方原始页面并记录实际核验日。
2. 金额、期限、电话、地址、申请入口和适用身份逐项对照正文。
3. 若网页受反自动化保护，改用同一机构的可访问页面或人工浏览器核验；不得直接标为失效。
4. 若来源实际失效且没有官方替代，不保留确定性结论，在正文中降格并记录待确认。
5. 完成全文链接检查、LaTeX 双遍编译和全部页面视觉复核后再发布。
