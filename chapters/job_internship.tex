...
\begin{enumerate}[leftmargin=2em,label=\arabic*.]
  ...
  \item \textbf{境外实习 / 工作}\\
        需申请目标国实习签；长期离境可能 \textbf{导致丹麦居留许可失效或需申报 CPR 迁出}（见第~\ref{sec:residence-lifecycle}~节）。
  \item \textbf{用工顺序}\\
...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item \textbf{照片}：通常不是必填项；先服从职位说明。决定使用时应保持职业，并避免披露与岗位无关的敏感信息。
...
除合同和劳动条件外，部分面向特定专业的工会或 A-kasse 还可能提供 CV/求职信反馈、薪资统计、模拟面试、职业咨询和活动。选择时不要只看学生优惠或社交平台推荐，应先核对：自己的专业和岗位是否属于服务范围、学生会员转为毕业会员后的费用、英文服务、退出条件，以及职业服务与失业保险资格是否为两件事。学校 Career Centre、Jobindex、Workindenmark 和企业官网仍应并行使用；任何 workshop、networking 或付费求职辅导都不能保证获得面试或工作。

\subsection{平台接单、自雇与志愿服务}

对非欧盟学生，报酬名称和平台界面不会改变工作许可要求。配送、家教、设计接单、内容创作、短期试工或以发票结算的 freelance，都应先判断是否属于工作、如何计入每月工时，以及本人许可是否允许该种工作形式。注册 CVR、拥有税卡或平台允许开户都不等于已经取得相应工作权利；无法从决定信判断时，应在开始前向 SIRI 书面确认。

SIRI 允许符合条件的高等教育学生为造福社会的组织或协会从事不限时数的无薪志愿工作，相关时数不计入有限工作许可；但“没有工资”本身不足以证明属于这一例外。替代普通有薪岗位的无薪试工、企业实习或带有实物报酬的安排，仍应按实际任务和许可核实。

毕业后如果已获或符合三年求职期条件，并完成符合要求的国家认可学历，可另行申请无工时限制的工作许可；获批前仍按现有许可工作。官方入口：\url{https://www.nyidanmark.dk/en-GB/You-want-to-apply/Study/Work-permit--job-seeking}
...
\begin{itemize}
  ...
  \item \textbf{聚焦简历}：精准对应 JD；照片通常不是必填项，避免把无关个人信息当作申请要求。
\end{itemize}
