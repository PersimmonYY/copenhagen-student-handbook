...
哥本哈根市课程、押金与学校信息：\url{https://international.kk.dk/live/learn-danish/danish-language-courses/danish-language-education-programme}
...
\midrule
Speak (Lyngby) & \href{mailto:hello@speakspeak.dk}{hello@speakspeak.dk} & \url{https://speakspeak.dk} \\
UCplus (Lyngby / Online) & \href{mailto:ei@ucplus.dk}{ei@ucplus.dk} & \url{https://ucplus.dk} \\
Clavis (Risø) & \href{mailto:kontakt@clavis.org}{kontakt@clavis.org} & \url{https://clavis.org} \\
DTU International Student Services & \href{mailto:international@adm.dtu.dk}{international@adm.dtu.dk} & \url{https://www.dtu.dk/english/education/guidance-and-counselling/international-student-services} \\
\bottomrule
\end{tabularx}
\end{table}
