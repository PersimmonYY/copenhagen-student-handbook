...
\begin{enumerate}[label=\arabic*.]
  ...
  \item \textbf{执法常识}：任何跨国“公检法”办案都不让你转账；丹麦警方执法只打 \textbf{112 / 114} 官方号码。
...
\begin{tabularx}{\textwidth}{p{0.20\textwidth} l X}
  ...
  \midrule
  丹麦报警 / 急救 & 112 & 生命危险 or 刚遭遇诈骗请先报警 \\
  丹麦非紧急警务 & 114 &  \\
  中国领事保护 & +86-10-12308（24h） & 中国驻外全球热线 \\
  驻丹麦大使馆领事保护热线 & +45-39 46 08 66（24h）  & 工作时间内大使馆工作人员直接接线；非工作时间会转入12308 \\
...
\begin{enumerate}[label=\arabic*.]
  \item \textbf{立即报警}：保留转账记录 / 对话 / 软件安装痕迹。
  \item \textbf{联系银行 / 支付平台}：申请冻结可疑账户或转账。
...
\begin{itemize}
    \item {“要钱、要账号、要远程” = 99 \% 诈骗；先挂断，打 114/12308 再决定。}
\end{itemize}
\end{grayleftbox}
