...
\begin{itemize}[leftmargin=2em,itemsep=3pt]
  ...
  \item 有 CPR 后尽快开通 MitID。符合护照芯片和 App 核验条件者可尝试自助开通；中国护照或手机无法完成扫描时，按 MitID 指引预约 Borgerservice/International House 核验身份，不要反复注册多个身份。手机不兼容时还可了解 MitID code display 等官方认证器，详见第~\ref{sec:finance-digital}~节。
\end{itemize}
