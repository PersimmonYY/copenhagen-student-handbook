...
\begin{longtable}{p{0.20\linewidth}p{0.31\linewidth}p{0.39\linewidth}}
  ...
  黄卡与家庭医生 & CPR 登记获批 & 登记时可选择家庭医生（未选择则由系统分配），实体黄卡通常随后邮寄；卡到之前也可凭 CPR 就医 \\
...
\begin{enumerate}[leftmargin=2.2em,itemsep=3pt]
  ...
  \item \textbf{完成学校报到和学生证申请。}检查学生邮箱、选课和迎新通知，向学校更新丹麦手机号和联系地址；拿到 CPR 后再按学校要求更新学生档案。学生证不一定自动制作，应检查学校自助系统是否需要上传照片、确认地址或主动订购。KU 学生须在 KUnet Self-service 的 ID card 页面上传照片；上传成功后保存页面显示的制作或领取信息。其他院校以本校流程为准。
...
\begin{itemize}[leftmargin=2em,itemsep=3pt]
  ...
  \item CPR 登记获批后，将按登记时选择的家庭医生（未选择则由系统分配）制作黄卡。实体卡尚未送达时，如登记已完成，通常仍可联系获分配的家庭医生就诊。
  \item 有 CPR 后尽快开通 MitID，不必为此等待实体居留卡寄到，也不要承诺 CPR 到账次日一定可用。符合护照芯片和 App 核验条件者可尝试自助开通；中国护照或手机无法完成扫描、CPR 数据尚未同步或身份核验条件不足时，按 MitID 指引预约 Borgerservice/International House 核验身份，不要反复注册多个身份。手机不兼容时还可了解 MitID code display 等官方认证器，详见第~\ref{sec:finance-digital}~节。
\end{itemize}
...
\begin{itemize}[leftmargin=2em,itemsep=3pt]
  \item \textbf{黄卡：}CPR 登记完成后通常 2--4 周寄到。超过 4 周仍未收到，先核对信箱姓名和登记地址，再联系 Borgerservice。CPR 登记完成并成功开通 MitID 后，可尝试激活 Sundhedskortet App；它在丹麦境内是有效的电子黄卡，不必等实体卡寄到才联系家庭医生。手机不可用或遇到特殊核验场景时，仍应准备 CPR 信息并按机构要求提供其他证明。
...
\begin{itemize}[leftmargin=2em,itemsep=2pt]
  ...
  \item KU 学生证办理：\url{https://jura.ku.dk/english/education/credit/when-you-are-enrolled/}
