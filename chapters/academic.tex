...
\begin{grayleftbox}
\textbf{本章适用前提：}默认读者是以非欧盟身份持有丹麦学生居留许可的中国留学生。若你是交换生、联合培养学生、博士生，或持有其他类型居留许可，请向本校 International Office/Student Services 与 SIRI 单独核实。本章国家法规与 SIRI 信息核验至 2026 年 8 月 12 日；院校细则仍以学生门户及具体课程当期说明为准。
\end{grayleftbox}
...
\begin{enumerate}
  ...
  \item 下载本人 curriculum/programme regulations 和当学年 study rules，并把选课、退课、考试报名、退考、作业及重考截止日期录入日历。
  \item 逐门保存 learning objectives、考试形式、允许工具与 AI 说明；同时核对学生系统中的课程和考试注册状态。
